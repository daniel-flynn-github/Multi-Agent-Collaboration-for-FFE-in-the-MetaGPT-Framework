...
##Persona specfic pain points: Provided as Python Dict[str, List[str]], the key is persona name, and the value is alist of persona issues. Create 1 pain points for each persona.
